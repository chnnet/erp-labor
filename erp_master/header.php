...
$nav = [
    'journal' => [
        ...
        'entries' => [
            ...
            'account_create.php' => Language::get('nav_account_create')
        ]
    ],
    'debitor' => [
        ...
        'entries' => [
            ...
            'book_debtor_invoice.php' => Language::get('nav_debtor_invoice'),
        ]
    ],
    'kreditor' => [
        ...
        'entries' => [
            ...
            'creditor_invoice.php' => Language::get('nav_creditor_invoice'),
        ]
    ],
    'system' => [
...
<nav>
    ...
    <div class="right-section">
        <form method="post" class="lang-switch">
            <select name="language" title="Sprache auswählen" onchange="this.form.submit()">
